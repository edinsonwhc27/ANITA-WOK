...
// Base de datos de productos (51 Productos)
const productos = [
  // 1. CHIFA Y CRIOLLO
  { id: 1, cat: 'chifa', nombre: 'Chaufa de Pollo', mesa: 14.00, llevar: 14.50, desc: 'Arroz salteado al wok, trozos de pollo, huevo, sillao y cebollita china.', img: 'https://cdn.blog.paulinacocina.net/wp-content/uploads/2021/12/arroz-chaufa-peruano-receta.jpg' },
  { id: 2, cat: 'chifa', nombre: 'Aeropuerto de Pollo', mesa: 14.00, llevar: 14.50, desc: 'Mezcla de arroz chaufa, fideo frito al wok, pollo y frijolito chino.', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRJawZvEG8_kKwAvSzH9p949H4oUV6W0dJA4qBX4wd9-h2v5uq_CZ7p4VKB&s=10' },
  { id: 3, cat: 'chifa', nombre: 'Aeropuerto de Chancho', mesa: 15.00, llevar: 15.50, desc: 'Chaufa, fideo salteado, trozos de chancho asado char siu y frijolito chino.', img: 'https://www.renacerelpunto.com/wp-content/uploads/2024/09/AEROPUERTO-CON-CHANCHO.jpg' },
  { id: 4, cat: 'chifa', nombre: 'Chaufa de Chancho', mesa: 15.00, llevar: 15.50, desc: 'Arroz salteado al wok con jugosos cortes de chancho asado dulce.', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTj4V9ObLZd4U7U-hQS-lOj1ZaPczrhIVqDFmqhUJS4P_LQqpFTw341Ubc&s=10' },
  { id: 5, cat: 'chifa', nombre: 'Chihaukay', mesa: 16.50, llevar: 17.00, desc: 'Pollo crujiente en salsa de ostión con ajonjolí acompañado de arroz chaufa.', img: 'https://www.kioninternacional.com/wp-content/uploads/2025/01/chijaukaychaufa.jpg' },
  { id: 7, cat: 'chifa', nombre: 'Tipakay', mesa: 16.50, llevar: 17.00, desc: 'Chicharrón de pollo agridulce bañado en salsa tamarindo con chaufa.', img: 'https://img-global.cpcdn.com/recipes/819cb89210d39293/1200x630cq80/photo.jpg' },
  { id: 8, cat: 'chifa', nombre: 'Maracu Wok', mesa: 18.00, llevar: 18.00, desc: 'Pollo crujiente estilo tipakay bañado en una especial y fresca salsa agridulce de maracuyá, acompañado de su clásico arroz chaufa.', img: 'https://images.unsplash.com/photo-1541696432-82c6da8ce7bf?q=80&w=400&auto=format&fit=crop' },
  { id: 9, cat: 'chifa', nombre: 'Combinado', mesa: 16.50, llevar: 17.00, desc: 'Clásica combinación de arroz chaufa de pollo y tallarín saltado chino.', img: 'https://www.barcidda.pe/wp-content/uploads/2025/03/ThumbComi.jpg' },
  { id: 48, cat: 'chifa', nombre: '8 Will', mesa: 16.50, llevar: 17.00, desc: 'Espectacular combinado salteado al wok que integra lo mejor de tres carnes: jugosos trozos de pollo, carne de res y fina cecina ahumada.', img: 'https://images.unsplash.com/photo-1512058564366-18510be2db19?q=80&w=400&auto=format&fit=crop' },
  { id: 10, cat: 'chifa', nombre: 'Amazónico', mesa: 16.50, llevar: 17.00, desc: 'Chaufa especial salteado con cecina ahumada, plátano frito y especias.', img: 'https://thumbs.dreamstime.com/b/gastronom%C3%ADa-de-la-selva-peruana-arroz-chaufa-cecina-chino-con-en-un-plato-217503353.jpg' },
  { id: 11, cat: 'chifa', nombre: 'Aeropuerto Amazónico', mesa: 16.50, llevar: 17.00, desc: 'Chaufa y fideos salteados con fina cecina de la selva y platano bellaco.', img: 'https://images.unsplash.com/photo-1512058564366-18510be2db19?q=80&w=400&auto=format&fit=crop' },
  ...
  { id: 13, cat: 'chifa', nombre: 'Pollo con Verduras', mesa: 15.50, llevar: 16.00, desc: 'Pechuga de pollo troceada con col china, pacoy, pimiento y holantao.', img: 'https://images.unsplash.com/photo-1541696432-82c6da8ce7bf?q=80&w=400&auto=format&fit=crop' },
  { id: 14, cat: 'chifa', nombre: 'Pollo Saltado', mesa: 16.00, llevar: 16.50, desc: 'Jugosos trozos de pechuga salteados con cebolla, tomate y papas fritas.', img: 'https://images.unsplash.com/photo-1585032226651-759b368d7246?q=80&w=400&auto=format&fit=crop' },
  { id: 15, cat: 'chifa', nombre: 'Tallarín Saltado Chino', mesa: 15.00, llevar: 15.50, desc: 'Fideos salteados al wok con frijolito chino, cebolla china y pollo.', img: 'https://images.unsplash.com/photo-1612927601601-6638404737ce?q=80&w=400&auto=format&fit=crop' },
  ...
  { id: 18, cat: 'chifa', nombre: '12 Wantán Frito', mesa: 12.00, llevar: 12.50, desc: 'Docena de láminas crujientes rellenas de pollo fritas con salsa tamarindo.', img: 'https://images.unsplash.com/photo-1541696432-82c6da8ce7bf?q=80&w=400&auto=format&fit=crop' },
  ...
  { id: 22, cat: 'chifa', nombre: 'Mostrito', mesa: 16.50, llevar: 17.00, desc: 'Combinado contundente de arroz chaufa, papas fritas crocantes y pollo broaster.', img: 'https://images.unsplash.com/photo-1562967914-608f82629710?q=80&w=400&auto=format&fit=crop' },
  ...
  { id: 49, cat: 'compartir', nombre: 'Combinado (Compartir)', mesa: 20.00, llevar: 20.00, desc: 'Bandeja familiar de arroz chaufa de pollo acompañado de tallarín saltado chino.', img: 'https://images.unsplash.com/photo-1612927601601-6638404737ce?q=80&w=400&auto=format&fit=crop' },
  { id: 50, cat: 'compartir', nombre: '8 Will (Compartir)', mesa: 20.00, llevar: 20.00, desc: 'Bandeja gigante para compartir de combinado salteado con tres carnes: pollo, carne de res y cecina ahumada.', img: 'https://images.unsplash.com/photo-1512058564366-18510be2db19?q=80&w=400&auto=format&fit=crop' },
